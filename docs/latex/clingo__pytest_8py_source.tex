...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{clingo__pytest_8py_source_l00001}00001\ \textcolor{keyword}{import}\ subprocess}
...
\DoxyCodeLine{\Hypertarget{clingo__pytest_8py_source_l00030}00030\ \textcolor{keyword}{def\ }run\_clingo(program\_files):}
...
\DoxyCodeLine{\Hypertarget{clingo__pytest_8py_source_l00037}00037\ \textcolor{keyword}{def\ }parse\_answer\_set(output):}
...
\DoxyCodeLine{\Hypertarget{clingo__pytest_8py_source_l00075}00075\ \textcolor{keyword}{def\ }test\_clingo\_output(input\_files,\ expected\_output):}
\DoxyCodeLine{\Hypertarget{clingo__pytest_8py_source_l00076}00076\ \ \ \ \ output\ =\ run\_clingo(input\_files)}
\DoxyCodeLine{\Hypertarget{clingo__pytest_8py_source_l00077}00077\ \ \ \ \ answer\_set\ =\ set(parse\_answer\_set(output))}
